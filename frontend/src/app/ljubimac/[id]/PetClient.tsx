...
export default function PetClient({ pet: p, isNew }: { pet: PetFull; isNew: boolean }) {
  ...
  const shareText = mapsUrl
    ? encodeURIComponent(`Pronašao/la sam vašeg ljubimca ${p.name}! 📍 Evo lokacije: ${mapsUrl}`)
    : ''
              ...
              <>
                ...
                {mapsUrl && (
                  <div className="space-y-2">
                    ...
                    {intlPhone && (
                      <div className="flex gap-2">
                        <a href={`https://wa.me/${waPhone}?text=${shareText}`}
                        ...
                        <a href={`viber://chat?number=${intlPhone}&text=${shareText}`}
                    ...
                    {/* SMS */}
                    {phone && (
                      <a href={`sms:${phone}?body=${shareText}`}
